...
import allow.adaptation.ensemble.Solution;
import allow.adaptation.ensemble.Solver;
...
public class Utilities {
	...
	public static void buildSolversMapMobility(List<EnsembleManager> ensembles) {
		...
		staticMap.put("BUS_BREAKDOWN", new String[] { "FlexibusDriver_13" });
		...
		Utilities.solversMapMobility.put("BUS_BREAKDOWN",
				new ArrayList<RoleManager>());
		// Utilities.solversMapMobility.put("RouteBlocked", new
		// ArrayList<RoleManager>());
		// Utilities.solversMapMobility.put("PassengerDelay", new
		// ArrayList<RoleManager>());
		// Utilities.solversMapMobility.put("DriversStrike", new
		// ArrayList<RoleManager>());
		// Utilities.solversMapMobility.put("CPAPassengerDelay", new
		// ArrayList<RoleManager>());
