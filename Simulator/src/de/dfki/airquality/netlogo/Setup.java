...
public class Setup extends DefaultReporter {
    ...
    LogoList settings = args[4].getList();
		...
		params.PercentAirQualitySensors = (int) (double) settings.get(0);
		params.SamplingInterval = (int) (double) settings.get(1);
		params.logfilePrefix = (String) settings.get(2);		
