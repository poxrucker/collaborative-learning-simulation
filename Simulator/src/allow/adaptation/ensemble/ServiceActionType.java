...
@XmlSeeAlso({
    allow.adaptation.ensemble.Fragment.State.class,
    allow.adaptation.ensemble.Fragment.Action.class,
    allow.adaptation.ensemble.Fragment.Transition.Action.class
})
