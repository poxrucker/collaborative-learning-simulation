...
public final class Itinerary {
    ...
    public static TType getItineraryType(Itinerary it) {
		...
		throw new IllegalStateException("Error: Cannot determine itinerary type.");
    }
    ...
    public String toString() {
    	return "[" + itineraryType + ", " + (duration + initialWaitingTime) + " s, " + costs + " €, " + maxFillingLevel + " fill grade, " + utility + "]";
    }
}
