...
public class TestMain {
	...
	public static void main(String[] args) {
		if (args.length < 0)
			System.out.println("Missing path to netlogo simulation file");
		...
		// PublicTransportation busDriver = new PublicTransportation(1, null,
		// null, null, 20);
		// Person passenger1 = new Person(2, Gender.MALE, Profile.WORKER, null,
		// null, c1, true, true, true, null, null);
		// Person passenger2 = new Person(3, Gender.MALE, Profile.WORKER, null,
		// null, c2, true, true, true, null, null);
		//
		// roles.add(busDriver);
